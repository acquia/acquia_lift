...
namespace Drupal\acquia_perz_push\Plugin\rest\resource;
...
/**
 * @RestResource(
 *   id = "acquia_perz_push_slow_endpoint",
 *   label = @Translation("Acquia Perz Push - Slow Endpoint for testing timeouts"),
 *   uri_paths = {
