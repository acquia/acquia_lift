...
class EntityRenderHandler implements EventSubscriberInterface {
   ...
   */
  protected function buildPreviewImageAttributeSource(array $view_modes, $preview_view_mode, $style, $translation) {
  ...
  protected function storageWarmUp(array $data, $source_uuid) {
    foreach ($data as $entity_info) {
      // Ensure we discard any result that does not match
      // Exactly the source_uuid.
